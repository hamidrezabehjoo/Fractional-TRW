...
np.savetxt("results/k16/zero/Z.txt", np.array(Z))
np.savetxt("results/k16/zero/C.txt", np.array(C))
np.savetxt("results/k16/zero/G.txt", np.array(G))
...
plt.grid()
plt.savefig("results/k16/zero/C_FTRW.pdf")
...
plt.grid()
plt.savefig("results/k16/zero/Z_FTRW.pdf")
...
plt.ylabel('$G$')
plt.grid()
plt.savefig("results/k16/zero/G.pdf")
#############################################################################################################
