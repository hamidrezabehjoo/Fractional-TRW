...
np.savetxt("results/4x4/non_zero/Z.txt", np.array(Z))
np.savetxt("results/4x4/non_zero/C.txt", np.array(C))
np.savetxt("results/4x4/non_zero/G.txt", np.array(G))
...
plt.grid()
plt.savefig("results/4x4/non_zero/C_FTRW.pdf")
...
plt.grid()
plt.savefig("results/4x4/non_zero/Z_FTRW.pdf")
...
plt.ylabel('$G$')
plt.grid()
plt.savefig("results/4x4/non_zero/G.pdf")
#############################################################################################################
